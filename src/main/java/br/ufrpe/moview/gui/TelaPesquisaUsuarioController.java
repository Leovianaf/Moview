...
public class TelaPesquisaUsuarioController implements Initializable {
    ...
    public void VerInfoUsuario(ActionEvent event) throws IOException {
        ...
        Usuario usuarioSelecionado = selectionModel.getSelectedItem(); // Obtém o filme selecionado

        if (usuarioSelecionado != null) {
            sessao.setUsuarioTemp(usuarioSelecionado); // Define o filme selecionado como filme temporário
            controladorCenas.TrocarOutroUsuario(event); // Navega para a TelaFilme
        }
    }
